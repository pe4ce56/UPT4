      ...
      <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #3829c3;">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav m-auto">
            <li class="nav-item">
              <a class="nav-link" href="<?=base_url('peserta/admin')?>">KEMBALI</a>
            </li>
            <li class="nav-item">
    ...
    <div class="content">
      ...
      <div class="services row ">
        <div class="mt-sm-1 col-lg-4 m-auto">
          <a href="<?=base_url('peserta/admindmkl')?>" style="text-decoration: none; color: black;">
          <div class="box">
            <div class="iconBx">
        ...
        <div class="mt-sm-1 col-12 m-auto col-lg-4">
          <a href="<?=base_url('peserta/admingkl')?>" style="text-decoration: none; color: black;">
          <div class="box">
            <div class="iconBx">
              <div class="icon d-flex align-items-center justify-content-center mx-auto">
        ...
        <div class="mt-sm-1 col-12 m-auto col-lg-4">
          <a href="<?=base_url('peserta/keldatakl')?>" style="text-decoration: none; color: black;">
          <div class="box">
            <div class="iconBx">
              <div class="icon d-flex align-items-center justify-content-center mx-auto">
