    ...
    <nav class="main-header navbar navbar-expand-md navbar-light navbar-white   shadow-lg p-3 bg-white rounded">
      <div class="container">
        ...
        <div class="collapse navbar-collapse order-3" id="navbarCollapse">
          ...
          <li class="nav-item">
              <a href="<?=base_url('peserta/admin')?>" class="nav-link">KEMBALI</a>
            </li>
            <li class="nav-item">
  ...
  <div class="card mx-auto mt-5" style="width: 60rem;">
    <div class="row border-dark">
      <div class="col-8" style="background: #ededf0">
        <div class="">
          <a href="<?=base_url()?>/gambar/peserta_daring/<?php echo $post['jk'] ?>" data-lightbox="mygallery"><img class="card-img-top mt-2" src="<?=base_url()?>/gambar/peserta_daring/<?php echo $post['jk'] ?>"  style="max-height:550px; max-width:600px;"></a>

          <hr>
        </div>

        <div class="">
          <a href="<?=base_url()?>/gambar/peserta_daring/<?php echo $post['kab_kota'] ?>" data-lightbox="mygallery"><img class="card-img-top mt-2" src="<?=base_url()?>/gambar/peserta_daring/<?php echo $post['kab_kota'] ?>"  style="max-height:350px;"></a>
