    ...
    <div class="content">
      ...
      <div class="services row ">
        <div class="mt-sm-1 col-lg-4 m-auto">
          <a href="<?=base_url('peserta/admindmdr')?>" style="text-decoration: none; color: black;">
          <div class="box">
            <div class="iconBx">
        ...
        <div class="mt-sm-1 col-12 m-auto col-lg-4">
          <a href="<?=base_url('peserta/admingdr')?>" style="text-decoration: none; color: black;">
          <div class="box">
            <div class="iconBx">
              <div class="icon d-flex align-items-center justify-content-center mx-auto">
        ...
        <div class="mt-sm-1 col-12 m-auto col-lg-4">
          <a href="<?=base_url('peserta/keldatadr')?>" style="text-decoration: none; color: black;">
          <div class="box">
            <div class="iconBx">
              <div class="icon d-flex align-items-center justify-content-center mx-auto">
