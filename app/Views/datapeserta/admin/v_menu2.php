  ...
  <section class="sec aboutus " id="layanan">
     <div class="container services row" style="margin-left: 350px; margin-bottom: 300px;">
      <div class="col-lg-4" style="padding: 0">
        <a href="<?=base_url('peserta/adminhal2kl')?>" style="text-decoration: none; color: black;">
      ...
      <div class="col-lg-4" style="padding: 0">
        <a href="<?=base_url('peserta/adminhal2dr')?>" style="text-decoration: none; color: black;">
          <div class="box mx-auto">
            <div class="iconBx text-center">
            ...
            <div class="content">
              ...
              <p><br>Berisi data peserta yang mengikuti pelatihan daring melalui aplikasi sijawara.</p>
            </div>
          </div>
      </div>
      </a>
