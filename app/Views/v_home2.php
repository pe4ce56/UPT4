<section id="home">
  ...
  <section class="sec aboutus " id="services">
    <div class="container services row">
      <div class="col-lg-4" >
        <a href="<?= base_url('analisisdata/admin') ?>" style="text-decoration: none; color: black;">
      ...
      <div class="col-lg-4" >
        <a href="<?= base_url('kursil/admin')?>" style="text-decoration: none; color: black;">
          <div class="box mx-auto">
            <div class="iconBx text-center">
      ...
      <div class="col-lg-4" >
        <a href="<?=base_url('pelatihan/admin')?>" style="text-decoration: none; color: black;">
          <div class="box mx-auto">
            <div class="iconBx text-center">
    ...
    <div class="col-lg-4" >
      <a href="<?=base_url('peserta/admin')?>" style="text-decoration: none; color: black;">
        <div class="box mx-auto">
          <div class="iconBx text-center">
    ...
    <div class="col-lg-4" >
      <a href="<?=base_url('sertifikat/admin')?>" style="text-decoration: none; color: black;">
        <div class="box mx-auto">
          <div class="iconBx text-center">
      ...
      <div class="col-lg-4" >
        <a href="<?= base_url('admin/sdmadmin') ?>" style="text-decoration: none; color: black;">
        <div class="box mx-auto">
          <div class="iconBx text-center">
