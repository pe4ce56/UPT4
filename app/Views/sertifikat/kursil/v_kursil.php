...
<body class="hold-transition layout-top-nav">
  ...
  <!-- /.navbar -->
  <p class="text-center" style="font-size: 35px; margin-top: 150px; text-transform: uppercase;">Sertifikat Peserta Kursil/Modul</p>
  <hr>
        ...
        <tbody>
          ...
          <?php foreach ($data as $row) : ?>
            <tr>
              ...
              <td>
                <a class="btn btn-warning" style="margin-bottom: 8px;" href="<?=base_url()?>/gambar/sertifikat_kursil/<?= $row["gambar"] ?>" data-lightbox="mygallery">
                  <i class="fa fa-eye"></i>
                </a>&nbsp;
                <a class="btn btn-info" href="" Download="<?=base_url()?>/gambar/sertifikat_kursil/<?= $row["gambar"] ?>">
