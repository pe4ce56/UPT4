        ...
        <div class="row">
          ...
          <div class="col">
            ...
            <div class="card mt-4" style="border-radius: 15px">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" method="post" action="<?=base_url('sertifikat/save_w')?>" enctype="multipart/form-data">
                <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-2">
                              <img src="<?=base_url()?>/gambar/sertifikat_webinar/default.jpg" class="img-thumbnail img-preview">
                            </div>
                            <div class="col-sm-6">
