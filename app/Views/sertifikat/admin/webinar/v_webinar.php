...
<body class="hold-transition layout-top-nav">
  ...
  <section class="content">
    <div class="container">
    <a href="<?= base_url('sertifikat/tambahwebinar') ?>" class="btn btn-primary btn-sm mb-3"><i class="fa fa-plus"></i>Tambah Data</a>
      <!-- <button class="btn btn-primary btn-sm mb-3" data-toggle="modal" data-target="#tambahdata"><i class="fa fa-plus"></i>Tambah Data</button> -->
            ...
            <tr>
              <td>
                  ...
                  <div class="dropdown-menu">
                    <!-- dropdown lihat -->
                  <a class="dropdown-item" href="<?=base_url()?>/gambar/sertifikat_webinar/<?= $row["gambar"] ?>" data-lightbox="mygallery">
                  <i class="fa fa-eye fa-fw text-warning"></i>
                  Lihat
                  </a>
                  <a class="dropdown-item" id="btn-hapus" data-No="<?= $row['No']?>">
                  <i class="fa fa-trash fa-fw text-danger"></i>
                  Hapus
                  </a>
                  <a class="dropdown-item" Download="<?=base_url()?>/gambar/sertifikat_webinar/<?= $row["gambar"] ?>">
                  <i class="fa fa-download fa-fw text-info"></i>
                  Unduh
                  </a>
                  <a class="dropdown-item" href="<?= base_url('sertifikat/ubahwebinar/'.$row['No']) ?>">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="form-group row">
              ...
              <div class="col-8">
                <input type="text" class="form-control" name="Bidang_Sertifikat" id="Bidang_Sertifikat" placeholder="BIDANG SERTIFIKAT">
              </div>
            </div>
            <div class="form-group row">
              <div class="col-4">
                <label>INSTANSI/KOP/UKM</label>
              </div>
              <div class="col-8">
                <input type="text" class="form-control" name="Instansi_Kop_UKM" id="Instansi_Kop_UKM" placeholder="INSTANSI/KOP/UKM">
              </div>
            </div>
            <div class="form-group row">
              <div class="col-4">
              ...
              <div class="col-8">
                <input type="text" class="form-control" name="No_Sertifikat" id="No_Sertifikat" placeholder="NO SERTIFIKAT">
              </div>
            </div>
            </div>
  ...
  $(document).on('click','#btn-hapus', function(){
    ...
    Swal.fire({
        ...
        if (result.value) {
          ...
          fetch (`${base_url}/Sertifikat/hapuswebinar/${No}`).then(()=>{
