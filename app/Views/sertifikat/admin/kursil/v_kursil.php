              ...
              <td>
                <div class="btn-group dropright">
                  ...
                  <div class="dropdown-menu">
                    <!-- dropdown lihat -->
                    <a class="dropdown-item" href="<?= base_url() ?>/gambar/sertifikat_kursil/<?= $row["gambar"] ?>" data-lightbox="mygallery">
                    ...
                    <a class="dropdown-item" href="<?= base_url('/gambar/sertifikat_kursil/') ?>/<?= $row["gambar"] ?>" download>
