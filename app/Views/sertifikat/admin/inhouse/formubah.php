        ...
        <div class="row">
          ...
          <div class="col">
            ...
            <div class="card mt-4" style="border-radius: 15px">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" method="post" action="<?=base_url('sertifikat/edit_i/'.$tampil['id'])?>" enctype="multipart/form-data">
                <div class="card-body">
                        ...
                        <div class="col-8">
                        <input type="text" class="form-control <?= ($validation->hasError('Bidang_Sertifikat')) ? 'is-invalid' : '';?>" id="Bidang_Sertifikat" name="Bidang_Sertifikat" placeholder="Bidang Sertifikat" value="<?= old('Bidang_Sertifikat'); ?>">
                            <div class="invalid-feedback">
                        ...
                        <div class="col-8">
                        <input type="text" class="form-control <?= ($validation->hasError('Instansi_Kop_UKM')) ? 'is-invalid' : '';?>" id="Instansi_Kop_UKM" name="Instansi_Kop_UKM" placeholder="Instansi/Koperasi/Ukm" value="<?= old('Instansi_Kop_UKM'); ?>">
                            <div class="invalid-feedback">
                        ...
                        <div class="col-8">
                        <input type="text" class="form-control <?= ($validation->hasError('No_Sertifikat')) ? 'is-invalid' : '';?>" id="No_Sertifikat" name="No_Sertifikat" placeholder="No.Sertifikat" value="<?= old('No_Sertifikat'); ?>" >
                            <div class="invalid-feedback">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-2">
                              <img src="<?=base_url()?>/gambar/sertifikat_inhouse/default.jpg" class="img-thumbnail img-preview">
                            </div>
                            <div class="col-sm-6">
                      ...
                      <a href="<?=base_url('sertifikat/adinhouse')?>" type="cancel" name="batal" class="btn btn-danger">Batal</a>
                    </div>
              </div>
              </form>
            </div>
