...
<body class="hold-transition layout-top-nav">
  ...
  <!-- /.navbar -->
  <p class="text-center" style="font-size: 35px; margin-top: 150px; text-transform: uppercase;">Sertifikat Peserta Inhouse</p>
  <hr>
  <section class="content">
    <div class="container ">
    <a href="<?= base_url('sertifikat/tambahinhouse') ?>" class="btn btn-primary btn-sm mb-3"><i class="fa fa-plus"></i>Tambah Data</a>
          ...
          <?php foreach ($data as $row) : ?>
            ...
            <td>
                  ...
                  <div class="dropdown-menu">
                    <!-- dropdown lihat -->
                  <a class="dropdown-item" href="<?=base_url()?>/gambar/sertifikat_inhouse/<?= $row["gambar"] ?>" data-lightbox="mygallery">
                  <i class="fa fa-eye fa-fw text-warning"></i>
                  Lihat
                  </a>
                  <a class="dropdown-item" onclick="return confirm('Apakah Anda Yakin Untuk Menghapus?');" href="hapus.php?id=<?= $row["id"] ?>">
                  <i class="fa fa-trash fa-fw text-danger"></i>
                  Hapus
                  </a>
                  <a class="dropdown-item" Download="<?=base_url()?>/gambar/sertifikat_inhouse/<?= $row["gambar"] ?>">
                  <i class="fa fa-download fa-fw text-info"></i>
                  Unduh
                  </a>
                  <a class="dropdown-item btn-edit" href="<?= base_url('sertifikat/ubahinhouse/'.$row['id']) ?>">
