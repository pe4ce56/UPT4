  ...
  <section class="sec aboutus " id="layanan">
    <div class="container services row" style=" margin-top: -300px;">
      <div class="col-lg-3" style="padding: 0;">
        <a href="<?=base_url('sertifikat/webinar')?>" style="text-decoration: none; color: black;">
      ...
      <div class="col-lg-3" style="padding: 0">
        <a href="<?=base_url('sertifikat/inhouse')?>" style="text-decoration: none; color: black;">
          <div class="box mx-auto">
            <div class="iconBx text-center">
        ...
        <div class="col-lg-3" style="padding: 0">
         <a href="<?=base_url('sertifikat/kursil')?>" style="text-decoration: none; color: black;">
          <div class="box mx-auto">
            <div class="iconBx text-center">
    ...
    <div class="col-lg-3" style="padding: 0">
     <a href="<?=base_url('sertifikat/pelatihan')?>" style="text-decoration: none; color: black;">
      <div class="box mx-auto">
        <div class="iconBx text-center">
