...
<body class="hold-transition layout-top-nav">
  ...
  <!-- /.navbar -->
  <p class="text-center" style="font-size: 40px; margin-top: 150px; margin-bottom: -100px; text-transform: uppercase;"> Data Pelatihan</p>
  ...
  <section class="sec aboutus " id="layanan">
    <div class="container services row" style="margin-left: 350px; margin-bottom: 300px;">
      <div class="col-lg-4" style="padding: 0">
        <a href="<?=base_url('pelatihan/adminhal2kl')?>" style="text-decoration: none; color: black;">
          <div class="box mx-auto">
            <div class="iconBx text-center">
              <i class="fa fa-handshake-o" aria-hidden="true" style="font-size: 70px; text-align: center;"></i>
            </div>
            <div class="content">
              <h2><br>Data Pelatihan Klasikal</h2>
              <p><br>Berisikan data pelatihan yang diselenggarakan secara tatap muka.</p>
            </div>
          </div>
        </a>
      </div>
      <div class="col-lg-4" style="padding: 0">
        <a href="<?=base_url('pelatihan/adminhal2dr')?>" style="text-decoration: none; color: black;">
          <div class="box mx-auto">
            <div class="iconBx text-center">
              <i class="fa fa-id-badge" aria-hidden="true" style="font-size: 70px; text-align: center;"></i>
            </div>
            <div class="content">
              <h2><br>Data Pelatihan Daring</h2>
              <p>Selain pelatihan klasikal, Kami juga menyelenggarakan pelatihan daring yang menjadi tren dalam masa pandemi covid19.</p>
            </div>
          </div>
      </div>
      </a>
