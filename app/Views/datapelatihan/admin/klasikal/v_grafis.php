    ...
    <nav class="main-header navbar navbar-expand-md navbar-light navbar-white   shadow-lg p-3 bg-white rounded">
      <div class="container">
        ...
        <div class="collapse navbar-collapse order-3" id="navbarCollapse">
          ...
          <li class="nav-item">
              <a href="<?=base_url('pelatihan/adminhal2kl')?>" class="nav-link">KEMBALI</a>
            </li>
            <li class="nav-item">
  ...
  <div class="card mx-auto mt-5" style="width: 60rem;">
    <div class="row border-dark">
      <div class="col-8" style="background: #ededf0">
        <div class="">
          <a href="<?=base_url()?>/gambar/pelatihan_klasikal/<?php echo $post['pelatihan'] ?>" data-lightbox="mygallery"><img class="card-img-top mt-2" src="<?=base_url()?>/gambar/pelatihan_klasikal/<?php echo $post['pelatihan'] ?>"  style="max-height:600px;"></a>
        </div>
      </div>
