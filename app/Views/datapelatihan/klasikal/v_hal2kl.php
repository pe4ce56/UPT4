...
use App\Controllers\Pelatihan;

<?=base_url()?>/template/plugins/fontawesome-free/css/all.min.css">
  <!-- Theme style -->
      ...
      <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #3829c3;">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav m-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="<?=base_url('pelatihan')?>">KEMBALI</a>
            </li>
          </ul>
        </div>
      </nav>
    ...
    <div class="content">
      ...
      <div class="services row ">
        <div class="mt-sm-1 col-lg-4 m-auto">
          <a href="<?=base_url('pelatihan/datamentahkl')?>" style="text-decoration: none; color: black;">
          <div class="box">
            <div class="iconBx">
        ...
        <div class="mt-sm-1 col-12 m-auto col-lg-4">
          <a href="<?=base_url('pelatihan/grafiskl')?>" style="text-decoration: none; color: black;">
          <div class="box">
            <div class="iconBx">
              <div class="icon d-flex align-items-center justify-content-center mx-auto">
        ...
        <div class="mt-sm-1 col-12 m-auto col-lg-4">
          <a href="kelompokdatakl/kelompokdatakl.php" style="text-decoration: none; color: black;">
          <div class="box">
            <div class="iconBx">
              <div class="icon d-flex align-items-center justify-content-center mx-auto">
