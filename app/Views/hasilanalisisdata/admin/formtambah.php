        ...
        <div class="row">
          ...
          <div class="col">
            ...
            <div class="card mt-4" style="border-radius: 15px" >
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" method="post" action="<?=base_url('analisisdata/save')?>" enctype="multipart/form-data">
                <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <iframe class="col-sm-4 pdf-preview" src="<?=base_url()?>/pdf/default.pdf"></iframe>
                            <div class="col-sm-6">
